  ...
  return (
    <section className="flex justify-center items-center">
      ...
      <div className="relative w-full h-[80vh] flex items-center justify-center" data-aos="zoom-in">
        <img src="https://minio.bocchikitsunei.com/bocchikitsuneiwebportfolio/Nei_PR_R.jpg" alt="Background Image" className="absolute inset-0 w-full h-full object-cover" />
